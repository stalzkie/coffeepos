              ...
              child: viewModel.orderItems.isEmpty
                  ...
                  : ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final imageUrl = item.product.imageUrl.startsWith('https')
                            ? item.product.imageUrl
                            : 'https://tepdcxtlykiugezsaamc.supabase.co/storage/v1/object/public/product-images/${item.product.imageUrl}';
